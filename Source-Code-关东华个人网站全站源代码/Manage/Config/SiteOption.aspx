<%@ page language="C#" autoeventwireup="true" inherits="Manage_I_Config_SiteOption, App_Web_aontrgda" masterpagefile="~/Manage/I/Default.master" enableviewstatemac="false" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
	...
	<tbody>
        ...
        <tr>
            ...
            <td>
               ...
               <span class="rd_red">*<%=Resources.L.是否启用SSL加密连接 %>(<%=Resources.L.如未配置证书 %>,<%=Resources.L.请勿开启 %>)</span>
            </td>
        </tr>
		<tr>
		...
		<tr>
			...
			<td>
				...
				<span class="rspan"><%=Resources.L.提示 %>：<%=Resources.L.为空则不允许被采集 %>,<%=Resources.L.如果你需要采集其他逐浪子站 %><a href="#">[<%=Resources.L.点此配置 %>]</a></span>
			</td>
		</tr>
