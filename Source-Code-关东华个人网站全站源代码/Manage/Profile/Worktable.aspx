<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa_WebSite_Manages_Worktable, App_Web_ekkxmwuz" masterpagefile="~/Common/Master/Empty.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<div class="panel panel-info Worktable_well">
    ...
    <div class="panel-body">
        <ul class="link_menu" style="list-style-type: none;">
            <li class="litd"><a href="../Config/SiteInfo.aspx"><i class="fa fa-cogs"></i></a>
                <br />
                <a href="../Config/SiteInfo.aspx" target="_self"><%=Resources.L.网站配置 %></a></li>
            <li class="litd"><a href="../Content/ModelManage.aspx?ModelType=1"><i class="fa fa-edit"></i></a>
                <br />
                <a href="../Content/ModelManage.aspx?ModelType=1" target="_self"><%=Resources.L.内容模型 %></a></li>
            <li class="litd"><a href="../Content/NodeManage.aspx"><i class="fa fa-university"></i></a>
                <br />
                <a href="../Content/NodeManage.aspx" target="_self"><%=Resources.L.节点设置 %></a></li>
            <li class="litd"><a href="../Template/LabelManage.aspx"><i class="fa fa-tags"></i></a>
                <br />
                <a href="../Template/LabelManage.aspx" target="_self"><%=Resources.L.标签设置 %></a></li>
            <li class="litd"><a href="../Template/TemplateSet.aspx"><i class="fa fa-cubes"></i>
                <br />
                <a href="../Template/TemplateSet.aspx" target="_self"><%=Resources.L.模板设置 %></a></li>
            <li class="litd"><a href="../User/AdminManage.aspx"><i class="fa fa-lock"></i></a>
                <br />
                <a href="../User/AdminManage.aspx" target="_self"><%=Resources.L.安全设定 %></a></li>
            <li class="litd"><a href="../Content/ContentManage.aspx"><i class="fa fa-file-text-o"></i></a>
                <br />
                <a href="../Content/ContentManage.aspx" target="_self"><%=Resources.L.内容管理 %></a></li>
        </ul>
    </div>
</div>
...
<div class="row padding_l_r10px">
    ...
    <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 padding5">
        <div class="panel panel-default">
            ...
            <div class="panel-body WorktableHeight">
                <asp:TextBox ID="NoteBook" runat="server" CssClass="form-control" TextMode="MultiLine" Style="max-width: 100%; height: 100%; resize: none;" Columns="50" />
            </div>
            <div class="panel-footer">
                <span><%=Resources.L.提示 %>：<%=Resources.L.记录随Cookies删除而消失 %></span>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    $(function () {
        ...
        for (var i = 0; i < data1.length; i++) {
            ...
            option1.series[0].data.push({ value: data1[i].ChildCount, name: data1[i].NodeName });
        }
