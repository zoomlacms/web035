<%@ page language="C#" masterpagefile="~/Manage/I/Default.master" autoeventwireup="true" inherits="Manage_I_Content_CreateHtmlContent, App_Web_5ctdovhv" clientidmode="Static" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
  ...
  <div class="Creat_tips">
    <div class="alert alert-danger fade in margin_b2px">
      ...
      <p style="padding-left: 50px; line-height: 40px;"> <strong> <span class='glyphicon glyphicon-warning-sign' style='color: #f00; font-size: 18px;'></span>
        ...
        <asp:LinkButton ID="btnCreate" OnClick="btnCreate_Click" runat="server"  CssClass="btn btn-warning" ><%=Resources.L.立即生成 %>>></asp:LinkButton>
        </strong> </p>
