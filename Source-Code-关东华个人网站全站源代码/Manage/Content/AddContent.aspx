<%@ page language="C#" autoeventwireup="true" inherits="V_Content_AddContent, App_Web_5ctdovhv" masterpagefile="~/Manage/I/Default.master" clientidmode="Static" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
        ...
        <div class="tab-content">
            <div class="tab-pane active" id="ConInfo">
                <table id="mainTable" class="table table-bordered table_padding0 addcontent_modeltale" >
                    <tr>
                        <td style="overflow-x:hidden;" class="col-sm-1 col-xs-1 fd_td_l"><asp:Label ID="bt_txt" runat="server" Text="<%$Resources:L,标题 %>"></asp:Label></td>
                   ...
                   <tr id="spec_tr">
                    ...
                    <tr runat="server">
                        <td class="fd_td_l"> 
                            <asp:Label ID="gjz_txt" runat="server" Text="<%$Resources:L,关键字 %>"></asp:Label>
                        </td>
                        <td>                             
                    ...
                    <tr id="CreateHTML" runat="server">
                        <td class="fd_td_l">
                            <asp:Label ID="Label1" runat="server" Text="<%$Resources:L,生成 %>"></asp:Label>&nbsp;
                        </td>
                        <td>
                            <asp:CheckBox ID="quickmake" runat="server" Checked="false" Text="<%$Resources:L,是否立即生成 %>" />&nbsp;
                        </td>
                    </tr>
                </table>
                ...
                <table class="table table-bordered table_padding0">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            </asp:RadioButtonList> <span class="pull-left rd_green">(<%=Resources.L.该操作只在节点管理下配置了允许发表评论时生效 %>!)</span>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:CheckBox ID="Makepdf" runat="server" Text="<%$Resources:L,启用 %>" />
                        </td>
                    </tr>
                </table>
            ...
            <div class="tab-pane fade" id="Reward">
                <table class="table table-bordered table_padding0">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="proweek" CssClass="form-control text_xs" runat="server"></asp:TextBox><%=Resources.L.天 %>
                        </td>
                    </tr>
                </table>
            </div>
