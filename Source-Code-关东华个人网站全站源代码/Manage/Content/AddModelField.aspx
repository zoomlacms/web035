<%@ page language="C#" masterpagefile="~/Manage/I/Default.master" autoeventwireup="true" inherits="Manage_I_Content_AddModelField, App_Web_5ctdovhv" clientidmode="Static" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<tbody runat="server" id="DivMapType" style="display: none">
    <tr>
        <td><strong>选择地图：</strong></td>
        <td>
            <asp:DropDownList ID="MapSel_Drop" runat="server" CssClass="form-control text_300">
