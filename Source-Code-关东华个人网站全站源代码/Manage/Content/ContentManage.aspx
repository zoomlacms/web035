<%@ page language="C#" autoeventwireup="true" inherits="Manage_I_Content_ContentManage, App_Web_03wetrgx" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<div>
	...
	<asp:Button ID="btnAudit" CausesValidation="false" runat="server" Visible="false"
		Text="<%$Resources:L,审核通过 %>" CssClass="btn btn-success" OnClick="btnAudit_Click" OnClientClick="if(!IsSelectedId()){alert('请选择审核项');return false;}else{return confirm('你确定要审核选中内容吗？')}" />
