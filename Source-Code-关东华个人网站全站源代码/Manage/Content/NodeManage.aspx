<%@ page language="C#" autoeventwireup="true" inherits="Manage_I_Content_NodeManage, App_Web_5ctdovhv" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<table class="table table-striped table-bordered table-hover nodelist_div">
	<tr class="gridtitle text-center">
		...
		<td ><strong><%=Resources.L.节点类型 %></strong></td>
