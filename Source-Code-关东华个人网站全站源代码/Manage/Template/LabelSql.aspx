<%@ page language="C#" autoeventwireup="true" inherits="Manage_I_Content_LabelSql, App_Web_fb1eygwd" masterpagefile="~/Manage/I/Default.master" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
  ...
  <asp:WizardStep ID="WizardStep1" EnableTheming="true" runat="server" Title="step1">
	<table class="table table-striped table-bordered table-hover">
	  ...
	  <tr>
		...
		<td class="text-left"><asp:TextBox ID="TxtLabelName" class="form-control text_405" runat="server" />
	  ...
	  <tr>
		...
		<td><asp:TextBox ID="TxtLabelIntro" class="form-control text_405" runat="server" TextMode="MultiLine" Rows="5"></asp:TextBox></td>
	  </tr>
	  <tr>
		<td class="text-right"><strong>数据架构：</strong></td>
		<td><asp:TextBox runat="server" CssClass="form-control text_405" ID="schema_Text" Text="DBO"></asp:TextBox>
