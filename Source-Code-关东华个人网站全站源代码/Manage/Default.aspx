<%@ page language="C#" autoeventwireup="true" inherits="Manage_I_Default, App_Web_4qs44fck" clientidmode="Static" enableEventValidation="false" viewStateEncryptionMode="Never" %><!DOCTYPE html>
<html>
<head>
...
<span class="logo3"><%:ZoomLa.Components.SiteConfig.SiteInfo.Webmaster %></span></span>
...
<i class="fa fa-lightbulb-o"></i> 10秒后或双击自动消失进入操作
<a href="/help.html" target="_blank">使用文档</a>
<asp:LinkButton runat="server" ID="NoShow_Btn" OnClick="NoShow_Btn_Click"><i class="fa fa-times-circle"></i> 不再显示</asp:LinkButton>
</div>
...
<div id="left_ul_div">
	...
	<%--	<li id="menu3_7_2"><a href="javascript:;" data-url="Shop/FreePost.aspx"><%=Resources.L.免邮设置%></a></li>--%>
		...
		<ul id="menu3_8" class="m_left_ulin">
            ...
            <li id="menu3_8_2"><a href="javascript:;" data-url="User/Promo/PromoList.aspx"><%=Resources.L.排行榜 %></a></li>
...
<script src="/JS/ICMS/Main.js?ver=20160106"></script>
