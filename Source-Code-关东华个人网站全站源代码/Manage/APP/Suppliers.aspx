<%@ page language="C#" autoeventwireup="true" inherits="manage_APP_Suppliers, App_Web_d0gzgolh" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
        ...
        <div role="tabpanel" class="tab-pane active" id="app">
            <table class="table table-striped table-bordered table-hover">
                ...
                <tr>
                    ...
                    <td>
                        <asp:Button ID="WeChat_Btn" class="btn btn-primary" runat="server" Text="配置" OnClick="WeChat_Btn_Click" />
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <span style="display: none;">
                            ...
                            <a href="http://developer.baidu.com/console#app/project" target="_blank">申请百度key</a>
                        </span>
                    </td>
                </tr>
            </table>
...
<div><asp:Button ID="KeyTj" runat="server" class="btn btn-primary" Text="提交" OnClick="KeyTj_Click" /></div>
</asp:Content>
