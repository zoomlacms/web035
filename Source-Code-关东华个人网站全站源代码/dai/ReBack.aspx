<%@ page language="C#" autoeventwireup="true" inherits="try_ReBack, App_Web_xlnriwtd" masterpagefile="~/Common/Master/Empty.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
                ...
                <div class="tab-content">
                    ...
                    <div role="tabpanel" class="tab-pane tab_div" id="setphone">
                        ...
                        <div id="cameraimg_div" class="imgaction">
                            <iframe id="camera_ifr" src="Camera.aspx" style="border: none; width: 100%; height: 400px;"></iframe>
                        </div>
                        <div class="text-center margin_t10">
                            <button type="button" class="btn btn-primary camera_btn" onclick="shoot(1)">拍摄照片</button>
