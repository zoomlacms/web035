...
var litlp = "<li><div class='input-group' style='width:100%'><span class='btn btn-default input-group-addon'>@op</span><textarea id='@op_t' style='width: 100%; height: 80px; ' value='@val'></textarea></div></li>";
//生成指定数目的选项
