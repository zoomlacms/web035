<%@ page language="C#" masterpagefile="~/User/Default.master" autoeventwireup="true" inherits="User_Info_UserBase, App_Web_mblhjhdh" clientidmode="Static" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
ControlToValidate="tbFax" CssClass="tips" ErrorMessage="只能输入整数"></asp:RegularExpressionValidator></td>
	  ...
	  <tr>
		...
		<td style=""><asp:TextBox ID="tbMobile" CssClass="form-control text_md pull-left" runat="server"></asp:TextBox>
	  ...
	  <tr>
		<td style="text-align: right">所属城市： </td>
...
ControlToValidate="tbIDCard" CssClass="tips"  ErrorMessage="请输入正确身份证号"></asp:RegularExpressionValidator></td>
	  ...
	  <tr>
		...
		<td style=""><asp:TextBox ID="tbHomepage" CssClass="form-control text_md" runat="server" Columns="30">http://</asp:TextBox></td>
		<td style="text-align: right">QQ号码： </td>
		<td style=""><asp:TextBox ID="tbQQ" CssClass="form-control text_md pull-left" runat="server"></asp:TextBox>
...
ControlToValidate="tbQQ" CssClass="tips" ErrorMessage="只接受数字输入"></asp:RegularExpressionValidator></td>
	  ...
	  <tr>
		<td style="text-align: right">MSN帐号： </td>
...
ValidationExpression="^[0-9]*$" CssClass="tips" ControlToValidate="tbMSN" ErrorMessage="只接受数字输入"></asp:RegularExpressionValidator></td>
	  ...
	  <tr>
		...
		<td style="text-align: right">UC帐号： </td>
...
ControlToValidate="tbICQ" CssClass="tips" ErrorMessage="只接受数字输入"></asp:RegularExpressionValidator>
	  ...
	  <tr>
		<td style="text-align: right">签名档： </td>
		...
		<td rowspan="2" style="text-align: right">隐私设定： </td>
	...
	<tbody id="Tabs1" style="display:none;">
	  <tr>
		<td style="text-align: right" >头像地址： </td>
	  ...
	  <tr>
		<td style="text-align: right">头像宽度： </td>
